...
<!-- Source: https://docs.deckset.com/skills/deckset-markdown-authoring/SKILL.md -->

# Deckset Markdown Authoring

Use this standalone compatibility skill to turn rough notes into production-ready Deckset markdown.
...
- Media modifiers are in image alt text.
