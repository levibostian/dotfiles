...
# Ensure mise install location resolves before oh-my-zsh plugins load.
...
suggest() {
    pi --print "suggest a bash command for the given input. ONLY respond with the command, do not include any explanations or additional text, newline characters, or \`\`\`. Here is the input: $1"
}
